...
namespace Intermediate_test
{
    class LineShape : BaseShape
    {
        ...
        public string[,] lineShape = new string[rnd2, rnd2];


        public LineShape(Point leftTop, char theChar) : base(leftTop, theChar)
        {
        ...
        {
            for (int i = 0; i < lineShape.GetLength(0); i++)
            {
                for (int l = 0; l < lineShape.GetLength(1); l++)
                {
